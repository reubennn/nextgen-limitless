 ...
 */
const useSecuredApi = (url, initialOptions = {}) => {
    const initialState = {
        error: null,
        loading: false,
        data: null,
    ...
    /** Auth0 access token function & check if user is authenticated */
    ...
    return {
        state,
        securedApiRequest: triggerApiCall,
        securedApiRequestWithOptions: (options) => updateOptions(options),
    };
};
